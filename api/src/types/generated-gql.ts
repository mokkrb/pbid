...
import { IContext } from '../typeDefs/context';
...
export type Query = {
  __typename?: 'Query';
  getUrls: Array<Maybe<Url>>;
};

export type Url = {
  __typename?: 'Url';
  minifiedUrl: Scalars['String'];
...
export type MutationResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  createUrl?: Resolver<Maybe<ResolversTypes['Url']>, ParentType, ContextType, RequireFields<MutationCreateUrlArgs, 'url'>>;
}>;
...
export type QueryResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  getUrls?: Resolver<Array<Maybe<ResolversTypes['Url']>>, ParentType, ContextType>;
}>;

export type UrlResolvers<ContextType = IContext, ParentType extends ResolversParentTypes['Url'] = ResolversParentTypes['Url']> = ResolversObject<{
  minifiedUrl?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
